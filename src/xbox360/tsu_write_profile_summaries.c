...
extern void ts4_online_save_profile(
    void *online_context, int profile_index
);

/* Swing_DLL.xex 0x8879BC28, registered as TSU_WriteProfileSummaries. */
u32 tsu_write_profile_summaries(ScriptContext *context)
{
