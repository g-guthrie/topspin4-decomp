...
class ProgressTests(unittest.TestCase):
    ...
    def test_first_matching_unit_has_reviewed_boundaries_and_symbols(self):
        ...
        self.assertIn("src/xbox360/session_match_accessor.c:", splits)
        ...
        self.assertIn("src/xbox360/tsu_reset_friends_leaderboard.c:", splits)
        self.assertIn("src/xbox360/tsu_fill_friends_leaderboard.c:", splits)
        self.assertIn("src/xbox360/tsu_debug_ind_dec_lobby_timer.c:", splits)
        self.assertIn("src/xbox360/tsu_save_profile.c:", splits)
        ...
        self.assertIn("start:0x887799B0 end:0x887799C0", splits)
        ...
        self.assertIn("start:0x8877FBC0 end:0x8877FC10", splits)
        self.assertIn("start:0x88783620 end:0x88783724", splits)
        self.assertIn("start:0x88787CE8 end:0x88787E0C", splits)
        self.assertIn("start:0x8879BB58 end:0x8879BC28", splits)
        ...
        self.assertIn("ts4_get_session_match_descriptor", symbols)
        ...
        self.assertIn("tsu_reset_friends_leaderboard", symbols)
        self.assertIn("tsu_fill_friends_leaderboard", symbols)
        self.assertIn("tsu_debug_ind_dec_lobby_timer", symbols)
        self.assertIn("tsu_save_profile", symbols)
