...
Xbox 360 retail baseline locked and imported into Ghidra. The current analysis denominator is 41,795 discovered functions across three XEX modules. One hundred ninety-nine functions have reviewed names. One hundred seventy reconstructed functions now compile to 100% code matches: 13,648 of 10,153,700 measured Swing code bytes (`0.13441405%`).
