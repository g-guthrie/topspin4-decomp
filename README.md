...
Xbox 360 retail baseline locked and imported into Ghidra. The current analysis denominator is 41,795 discovered functions across three XEX modules. One hundred forty-nine functions have reviewed names. One hundred twelve reconstructed functions now compile to 100% code matches: 12,028 of 10,153,700 measured Swing code bytes (`0.118459284%`).
