...
Xbox 360 retail baseline locked and imported into Ghidra. The current analysis denominator is 41,795 discovered functions across three XEX modules. Two hundred thirty-four functions have reviewed names. Two hundred five reconstructed functions now compile to 100% code matches: 14,800 of 10,153,700 measured Swing code bytes (`0.14575967%`).
