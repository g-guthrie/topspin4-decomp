...
Xbox 360 retail baseline locked and imported into Ghidra. The current analysis denominator is 41,795 discovered functions across three XEX modules. Seventy-four functions have reviewed names. Thirty-one reconstructed functions now compile to 100% code matches: 2,156 of 10,153,700 measured Swing code bytes (`0.021233639%`).
