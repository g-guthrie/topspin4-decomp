...
Xbox 360 retail baseline locked and imported into Ghidra. The current analysis denominator is 41,795 discovered functions across three XEX modules. One hundred twenty-five functions have reviewed names. Eighty-eight reconstructed functions now compile to 100% code matches: 10,320 of 10,153,700 measured Swing code bytes (`0.101637825%`).
