...
Xbox 360 retail baseline locked and imported into Ghidra. The current analysis denominator is 41,795 discovered functions across three XEX modules. One hundred thirty functions have reviewed names. Ninety-three reconstructed functions now compile to 100% code matches: 10,804 of 10,153,700 measured Swing code bytes (`0.10640456%`).
