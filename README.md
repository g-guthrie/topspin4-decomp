...
Xbox 360 retail baseline locked and imported into Ghidra. The current analysis denominator is 41,795 discovered functions across three XEX modules. Two hundred forty-two functions have reviewed names. Two hundred thirteen reconstructed functions now compile to 100% code matches: 15,060 of 10,153,700 measured Swing code bytes (`0.14832032%`).
