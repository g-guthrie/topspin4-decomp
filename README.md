...
Xbox 360 retail baseline locked and imported into Ghidra. The current analysis denominator is 41,795 discovered functions across three XEX modules. Seventy-three functions have reviewed names. Thirty reconstructed functions now compile to 100% code matches: 1,988 of 10,153,700 measured Swing code bytes (`0.01957907%`).
