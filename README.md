...
Xbox 360 retail baseline locked and imported into Ghidra. The current analysis denominator is 41,795 discovered functions across three XEX modules. One hundred thirty-two functions have reviewed names. Ninety-five reconstructed functions now compile to 100% code matches: 11,072 of 10,153,700 measured Swing code bytes (`0.109044%`).
